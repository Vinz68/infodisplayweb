var
    ...
    slidesUrl = location.origin + "/slides";   // REST-API address to get list of (html) slide pages (embedding the PPT-JPG images)
    pagesUrl = location.origin + "/pages";     // REST-API address to get list of (html) pages

// Log the URLs and host (remove after suc6full tests)
console.log("host, slidesUrl =");
console.log(host);
...
$(function () {
    ...
    // First page title
    var title_info1 = "<h1 class='text-center'>Information Display</h1>";
